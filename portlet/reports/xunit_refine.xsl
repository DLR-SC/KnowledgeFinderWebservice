...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:param name="TITLE">ADAM Test report</xsl:param>
    ...
    <xsl:template match="testsuites">
        <html>
            <head>
                ...
                <style type="text/css">
                    body {
                    font:normal 91% verdana,arial,helvetica;
                    color:#000000;
                    }
        ...
        function displayProperties (name) {
          ...
          doc.write("<style>")
          doc.write("body {font:normal 91% verdana,arial,helvetica; color:#000000; }");
          doc.write("table tr td, table tr th { font-size: 91%; }");
    ...
    <!-- Name | Tests | Errors | Failures | Skipped | Time      not "Skipped"         -->
    <!-- ================================================================== -->
    ...
    <xsl:template name="summary">
        ...
        <!--<xsl:variable name="testCount" select="($myTestCount)"/>-->
        ...
        <xsl:variable name="timestamp" select="testsuite/@timestamp"/>
        ...
        <h3>
            ...
            <!-- Errors are currently not recognized/supported, i. e. they cannot occur
            <xsl:value-of select="$errorCount" /> <xsl:text> Errors and</xsl:text>
            -->
            <xsl:value-of select="$skippedCount" /> <xsl:text> Skipped.</xsl:text>
        </h3>

        <!-- Currently, the report does not generate markedFailing, so it is omitted
        ...
        <table border="0" width="95%">
            <tr>
                <td style="text-align: justify;">
                    Note: <i>failures</i> are anticipated and checked for with assertions while <i>errors</i> are unanticipated. Currently (2015-02-17), the mocha/xunit report does not support the <i>errors</i> type at all (always 0).
                </td>
            </tr>
        </table>
    </xsl:template>
