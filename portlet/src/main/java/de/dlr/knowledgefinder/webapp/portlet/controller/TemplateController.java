 ...
 *******************************************************************************/
package de.dlr.knowledgefinder.webapp.portlet.controller;
...
public class TemplateController {
	...
	public ModelAndView handleViewRenderRequest(RenderRequest request, RenderResponse response) {
		...
		try {
			...
			String urlNodes = wserver.getProperty(HOST_FIELD) + wserver.getProperty(URL_FIELD)
					+ wserver.getProperty(URL_NODES);
	...
	private void addfacetsListEntry(Map<String, Map<String, Object>> list, List<Map<String, Object>> facets,
			Map<String, Object> parentFacet) {
		if (facets != null) {
