...
public class KnowledgeFinderServiceClp implements KnowledgeFinderService {
    ...
    public java.util.Map<java.lang.String, java.util.List<de.dlr.knowledgefinderII.webapp.webservice.solr.SimpleCount>> getNodes(
        ...
        return (java.util.Map<java.lang.String, java.util.List<de.dlr.knowledgefinderII.webapp.webservice.solr.SimpleCount>>) ClpSerializer.translateOutput(returnObj);
    }
